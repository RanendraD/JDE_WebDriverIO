...
global.downloadDir = path.join(__dirname, 'xmlDownload');

global.resultDir = path.join(__dirname,'logs');
...
exports.config = {
    ...
    baseUrl: baseUrl,//'http://denac144.us.oracle.com:25022/jde/E1Menu.maf', 
